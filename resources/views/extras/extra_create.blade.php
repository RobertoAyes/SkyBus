...
@section('contenido')
        ...
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-warning d-flex align-items-center">
                    ...
                    Solo puedes seleccionar servicios si tienes una reserva activa a la que no le hayas
                    agregado servicios adicionales con anterioridad.
                </div>
                ...
                @if ($errors->has('extras_seleccionados'))
                    <div class="alert alert-danger d-flex align-items-center">
                        <i class="fas fa-exclamation-circle me-2"></i>
                        {{ $errors->first('extras_seleccionados') }}
                    </div>
                @endif
                            ...
                            <nav>
                                ...
                                <ul class="pagination pagination-sm mb-0">
                                    ...
                                    <li class="page-item {{ $extras->onFirstPage() ? 'disabled' : '' }}">
                                        ...
                                        <a class="page-link"
                                           href="{{ $extras->appends(request()->all())->previousPageUrl() }}">
                                            Anterior
                                        </a>
                                    ...
                                    @for($page = 1; $page <= $extras->lastPage(); $page++)
                                        ...
                                        <li class="page-item {{ $page == $extras->currentPage() ? 'active' : '' }}">
                                            ...
                                            <a class="page-link"
                                               href="{{ $extras->appends(request()->all())->url($page) }}">
                                                {{ $page }}
                                            </a>
                                    ...
                                    <li class="page-item {{ $extras->hasMorePages() ? '' : 'disabled' }}">
                                        ...
                                        <a class="page-link"
                                           href="{{ $extras->appends(request()->all())->nextPageUrl() }}">
                                            Siguiente
                                        </a>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center">
                                    ...
                                    Solo puede seleccionar 3 servicios adicionales por reserva.
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const max3Modal = new bootstrap.Modal(
                document.getElementById('max3Modal')
            );
            ...
            function toggleBtn() {
                ...
                const seleccionados =
                    Array.from(checks).filter(c => c.checked);
            ...
            checks.forEach(c =>
                c.addEventListener('change', toggleBtn)
            );
