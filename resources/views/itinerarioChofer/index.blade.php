...
@section('content')
    <div class="container mt-4">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <a href="#" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modalAsignarItinerario">
                        ...
                        <div class="card border-0 shadow-sm mb-4" style="background:#f8faff;">
                            <div class="card-body">
                                ...
                                <div class="row g-2 mb-2 px-1">
                                    <div class="col"><small class="fw-semibold text-muted" style="font-size:.68rem;">Lugar de parada</small></div>
                                    <div class="col-auto" style="width:120px;"><small class="fw-semibold text-muted" style="font-size:.68rem;">Tiempo (min)</small></div>
    ...
    {{-- SCRIPT PARA AGREGAR/REMOVER PARADAS --}}
    <script>
